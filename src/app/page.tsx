...
function ListPostCard({ image, category, title }: ListPostCardProps) {
  ...
  return (
    <div className="list-post-card flex items-center gap-3">
      <div className="post-img flex-shrink-0">
        <Link href="/blogs/schools-closed-islamabad-may-7-2025">
      ...
      <div className="post-content">
        <Link href="/blogs/schools-closed-islamabad-may-7-2025" className={`category text-xs inline-block px-2 py-0.5 ${getCategoryColor(category)} text-white font-medium rounded-sm`}>
          {category}
        </Link>
        <h3 className="title text-xs sm:text-sm font-medium leading-tight mt-1">
          <HoverLink href="/blogs/schools-closed-islamabad-may-7-2025">
            {title}
          </HoverLink>
        </h3>
